...
const Product = (props) => {
    ...
    const { id,name, price, quantity, img, category, stock, shipping, seller, ratings, ratingsCount } = props.product;
    ...
    return (
        <div className='product'>
            ...
            <FontAwesomeIcon className='basket' icon={faShoppingCart} /></button>
        </div>
    );
};
